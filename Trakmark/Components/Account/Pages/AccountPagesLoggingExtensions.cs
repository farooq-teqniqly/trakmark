...
internal static partial class AccountPagesLoggingExtensions
{
    ...
    internal static partial void LogExternalLoginSuccess(this ILogger logger, string? name, string loginProvider);

    [LoggerMessage(Level = LogLevel.Information, Message = "User created an account using {LoginProvider} provider.")]
    internal static partial void LogUserCreatedWithExternalProvider(this ILogger logger, string loginProvider);
    ...
    internal static partial void LogUserLoggedInWithRecoveryCode(this ILogger logger, string userId);
